                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                  ...
                                  <div class="input-group-text"><span class="fas fa-eye" toggle="#password" type="button" id="ps"></span></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group-text"><span class="fas fa-eye" toggle="#password-confirm" type="button" id="psc"></span></div>
                                </div>
                            </div>
                        </div>
